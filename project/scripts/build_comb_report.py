...
def build():
    ...
    A('<section><h2>쓴 재료</h2>'
      ...
      '<p class="sub">무광 검정 페인트의 정반사는 <b>제대로 칠하면 1 % 아래</b>입니다. '
      'TAMU 2014 가 도료·테이프·플록·펠트 스무 종 넘게 재서 전부 0.2 % 아래, '
      'Zeng 2019 의 Z307 은 정면에서 완전 확산체와 1 % 안, Nextel 811-21 은 '
      '광택도(ISO 2813) 2 이하입니다. 한 논문이 아크릴 스프레이 하나를 10 % 로 '
      '재는데, 그 시료는 <b>같은 논문의 칠판 페인트보다 네 배, 무소보다 열 배 넘게</b> '
      '높고, 논문 스스로 도막이 얇아 아래 연마 알루미늄이 비칠 수 있다고 적습니다. '
      '<b>미광용 검정은 여러 겹 칠하는 것이 표준입니다</b> — 여덟 겹을 칠한 연구도 '
      '있습니다. 발주서에 도장 횟수와 표면 준비를 적으십시오.</p></section>')
    ...
    A('<section><h2>그래서 사려면</h2><div class="card">'
      ...
      '도장입니다. 도장 횟수, 표면 준비, 그리고 시험 조각 한 장으로 확인하는 절차를 '
      '적어야 합니다.</p>'
